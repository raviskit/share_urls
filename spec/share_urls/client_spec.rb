...
RSpec.describe ShareUrls::Client do
  ...
  describe "#shorten_link" do
    ...
    it "raise ShareUrls::ConnectionError if Faraday::ConnectionFailed raised" do
      allow_any_instance_of(described_class).to receive(:connection).and_return(connection_failed_class.new)
      expect do
        subject.shorten_link("http://abc.com")
      end.to raise_error(ShareUrls::ConnectionError)
    end

    it "raise ShareUrls::ConnectionError if Faraday::TimeoutError raised" do
