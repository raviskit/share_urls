...
module ShareUrls
  ...
  class Client
    ...
    def initialize
      @link_renderer = ShareUrls::Link.new
      @connection = ShareUrls::Connection.new(end_point)
    end

    # @param link [String] required
    # @param options [Hash]
    #   * :timeout optional, default is ShareUrls.config.timout
    #   * :open_timeout [Integer] optional, default is ShareUrls.config.open_timout
    #   * :suffix_option [String] optional, default is ShareUrls.config.suffix_option
    #   * :dynamic_link_domain [String] optional, default is ShareUrls.config.dynamic_link_domain
    # @return [Hash{Symbol=>String}]
    # @see ShareUrls::Link#render Link#render for returned Hash
    def shorten_link(link, options = {})
      ...
      raise ShareUrls::ConnectionError, e.message
    end
    ...
    def shorten_parameters(params, options = {})
      ...
      dynamic_link_domain ||= config.dynamic_link_domain || raise(ShareUrls::InvalidConfig, "Dynamic link domain is empty")
    ...
    def_delegators :ShareUrls, :config
