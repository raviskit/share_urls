...
module ShareUrls
  ...
  class Link
    ...
    #   }
    # @raise ShareUrls::ConnectionError if there is something wrong with Faraday request
    # @raise ShareUrls::QuotaExceeded if request reached Google Firebase quota
    def render(response)
    ...
    def raise_error(response)
      ...
      raise ShareUrls::ConnectionError, [reason, message].compact.join(": ")
    end

    def raise_limit_has_reached
      raise ShareUrls::QuotaExceeded, "Request limit has been reached"
    end
  end
end
